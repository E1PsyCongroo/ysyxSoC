...
class APBSPI(address: Seq[AddressSet])(implicit p: Parameters) extends LazyModule {
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    val spifire       = mspi.io.in.penable && mspi.io.in.pready
    val outfire       = in.
    ...
    state := MuxLookup(state, sIdle)(Seq(
      ...
      sAccessSPI      -> Mux(spifire, sIdle, sAccessSPI),
      sAccessTx       -> Mux(spifire, sAccessDivider, sAccessTx),
      sAccessDivider  -> Mux(spifire, sAccessSs, sAccessDivider),
      sAccessSs       -> Mux(spifire, sAccessCtrl, sAccessSs),
      sAccessCtrl     -> Mux(spifire, sWaitData, sAccessCtrl),
      sWaitData       -> Mux(spifire && !mspi.io.in.prdata(9), sSendBack, sWaitData),
      sSendBack       -> Mux(spifire, sIdle, sSendBack),
    ))
    ...
    SPIReq.pwrite   := Mux(isAccessSPI, in.pwrite, false.B)
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:106)
	...
	scala.tools.nsc.typechecker.Typers$Typer.typedSelect$1(Typers.scala:5273)
	scala.tools.nsc.typechecker.Typers$Typer.typedSelectOrSuperCall$1(Typers.scala:5417)
	scala.tools.nsc.typechecker.Typers$Typer.typed1(Typers.scala:5992)
	scala.tools.nsc.typechecker.Typers$Typer.typed(Typers.scala:6047)
	...
	scala.tools.nsc.typechecker.Typers$Typer.typed(Typers.scala:6047)
	scala.tools.nsc.typechecker.Typers$Typer.typedArg(Typers.scala:3421)
	scala.tools.nsc.typechecker.Typers$Typer.$anonfun$typedArgs$1(Typers.scala:3426)
	scala.tools.nsc.typechecker.Typers$Typer.typedArgs(Typers.scala:3426)
	scala.tools.nsc.typechecker.Typers$Typer.tryTypedArgs$1(Typers.scala:4921)
	scala.tools.nsc.typechecker.Typers$Typer.onError$2(Typers.scala:4982)
	scala.tools.nsc.typechecker.Typers$Typer.tryTypedApply$1(Typers.scala:5013)
